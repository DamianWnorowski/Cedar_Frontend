	...
	render() {
		return (
            ...
            <Container textAlign='center' style={{backgroundColor:'black', color:'white', padding:'2em'}}>
                ...
                <p>Do not post spam reviews, create more than one account per person, use profanity, or post anything illegal under the laws of the United States of America, the State of New York, its county of Suffolk, its town of Brookhaven, and its hamlet of Stony Brook.</p>
